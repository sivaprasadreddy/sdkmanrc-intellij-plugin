...
This is an IntelliJ IDEA plugin that provides auto-completion for `.sdkmanrc` files. 
It suggests SDK names and locally-installed versions from `~/.sdkman/candidates/`.
